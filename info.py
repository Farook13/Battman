...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : BATMAN')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002256041072')) #Log channel id ( make sure bot is admin )
...
MULTI_CLIENT = False
name = str(environ.get('name', 'Batman'))
